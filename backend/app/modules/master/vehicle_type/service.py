...
from .repository import VehicleTypeRepository
...
class VehicleTypeService(BaseService):
    ...
    def _parse_uuid(self, raw_id):
        ...
        try:
            ...
            raise NotFoundException("VehicleType not found.", code="ERR_NOT_FOUND")

    def create(self, data: dict) -> VehicleType:
    ...
    def update(self, entity_id: str, data: dict) -> VehicleType:
    ...
    def get(self, entity_id: str) -> VehicleType:
        uid = self._parse_uuid(entity_id)
        entity = self.repository.get(uid)
        if not entity:
            raise NotFoundException("VehicleType not found.", code="ERR_NOT_FOUND")
