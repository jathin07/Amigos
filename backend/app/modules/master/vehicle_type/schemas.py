...
class CreateVehicleTypeRequestSchema(Schema):
...
class UpdateVehicleTypeRequestSchema(Schema):
...
class VehicleTypeLookupResponseSchema(Schema):
    id   = fields.UUID()
    name = fields.String()
    code = fields.String()

class VehicleTypeSummaryResponseSchema(Schema):
    id            = fields.UUID()
    name          = fields.String()
    code          = fields.String()
    is_active     = fields.Boolean()
...
class VehicleTypeDetailResponseSchema(VehicleTypeSummaryResponseSchema):
