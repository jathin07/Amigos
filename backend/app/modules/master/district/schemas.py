...
class CreateDistrictRequestSchema(Schema):
...
class UpdateDistrictRequestSchema(Schema):
...
class DistrictLookupResponseSchema(Schema):
    id   = fields.UUID()
    name = fields.String()
    code = fields.String()


class DistrictSummaryResponseSchema(Schema):
    id        = fields.UUID()
    name      = fields.String()
    code      = fields.String()
    is_active = fields.Boolean()
...
class DistrictDetailResponseSchema(DistrictSummaryResponseSchema):
    state_id      = fields.UUID()
