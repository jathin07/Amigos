...
class CreatePackageCategoryRequestSchema(Schema):
...
class UpdatePackageCategoryRequestSchema(Schema):
...
class PackageCategoryLookupResponseSchema(Schema):
    id   = fields.UUID()
    name = fields.String()
    code = fields.String()

class PackageCategorySummaryResponseSchema(Schema):
    id            = fields.UUID()
    name          = fields.String()
    code          = fields.String()
    is_active     = fields.Boolean()
...
class PackageCategoryDetailResponseSchema(PackageCategorySummaryResponseSchema):
