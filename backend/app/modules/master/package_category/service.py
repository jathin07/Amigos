...
from .repository import PackageCategoryRepository
from .models import PackageCategory

class PackageCategoryService(BaseService):
    def __init__(self):
        self.repository = PackageCategoryRepository()
    ...
    def _parse_uuid(self, raw_id):
        ...
        try:
            ...
            raise NotFoundException("PackageCategory not found.", code="ERR_NOT_FOUND")

    def create(self, data: dict) -> PackageCategory:
    ...
    def update(self, entity_id: str, data: dict) -> PackageCategory:
    ...
    def get(self, entity_id: str) -> PackageCategory:
        uid = self._parse_uuid(entity_id)
        entity = self.repository.get(uid)
        if not entity:
            raise NotFoundException("PackageCategory not found.", code="ERR_NOT_FOUND")
