...
class CreateHotelCategoryRequestSchema(Schema):
...
class UpdateHotelCategoryRequestSchema(Schema):
...
class HotelCategoryLookupResponseSchema(Schema):
    id   = fields.UUID()
    name = fields.String()
    code = fields.String()

class HotelCategorySummaryResponseSchema(Schema):
    id            = fields.UUID()
    name          = fields.String()
    code          = fields.String()
    is_active     = fields.Boolean()
...
class HotelCategoryDetailResponseSchema(HotelCategorySummaryResponseSchema):
