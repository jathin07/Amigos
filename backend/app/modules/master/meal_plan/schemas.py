...
class CreateMealPlanRequestSchema(Schema):
...
class UpdateMealPlanRequestSchema(Schema):
...
class MealPlanLookupResponseSchema(Schema):
    id   = fields.UUID()
    name = fields.String()
    code = fields.String()

class MealPlanSummaryResponseSchema(Schema):
    id            = fields.UUID()
    name          = fields.String()
    code          = fields.String()
    is_active     = fields.Boolean()
...
class MealPlanDetailResponseSchema(MealPlanSummaryResponseSchema):
