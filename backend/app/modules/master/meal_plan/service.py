...
from .repository import MealPlanRepository
from .models import MealPlan

class MealPlanService(BaseService):
    def __init__(self):
        self.repository = MealPlanRepository()
    ...
    def _parse_uuid(self, raw_id):
        ...
        try:
            ...
            raise NotFoundException("MealPlan not found.", code="ERR_NOT_FOUND")

    def create(self, data: dict) -> MealPlan:
    ...
    def update(self, entity_id: str, data: dict) -> MealPlan:
    ...
    def get(self, entity_id: str) -> MealPlan:
        uid = self._parse_uuid(entity_id)
        entity = self.repository.get(uid)
        if not entity:
            raise NotFoundException("MealPlan not found.", code="ERR_NOT_FOUND")
