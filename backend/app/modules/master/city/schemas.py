...
class CreateCityRequestSchema(Schema):
...
class UpdateCityRequestSchema(Schema):
...
class CitySummaryResponseSchema(Schema):
    id        = fields.UUID()
    name      = fields.String()
    code      = fields.String()
    is_active = fields.Boolean()
...
class CityDetailResponseSchema(CitySummaryResponseSchema):
    District_id   = fields.UUID()
    state_id      = fields.UUID()
