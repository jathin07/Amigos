...
class CreateActivityTypeRequestSchema(Schema):
...
class UpdateActivityTypeRequestSchema(Schema):
...
class ActivityTypeLookupResponseSchema(Schema):
    id   = fields.UUID()
    name = fields.String()
    code = fields.String()

class ActivityTypeSummaryResponseSchema(Schema):
    id            = fields.UUID()
    name          = fields.String()
    code          = fields.String()
    is_active     = fields.Boolean()
...
class ActivityTypeDetailResponseSchema(ActivityTypeSummaryResponseSchema):
