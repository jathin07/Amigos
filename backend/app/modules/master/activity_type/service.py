...
class ActivityTypeService(BaseService):
    ...
    def _parse_uuid(self, raw_id):
        ...
        try:
            ...
            raise NotFoundException("ActivityType not found.", code="ERR_NOT_FOUND")

    def create(self, data: dict) -> ActivityType:
    ...
    def update(self, entity_id: str, data: dict) -> ActivityType:
    ...
    def get(self, entity_id: str) -> ActivityType:
        uid = self._parse_uuid(entity_id)
        entity = self.repository.get(uid)
        if not entity:
            raise NotFoundException("ActivityType not found.", code="ERR_NOT_FOUND")
